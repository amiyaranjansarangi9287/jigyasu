          ...
          <div className="flex flex-wrap justify-center gap-1 mt-3">
            {[0, 30, 45, 60, 90, 180, 270, 360].map(a => (
              <button key={a} onClick={() => setAngle(a)}
                className={`px-2 py-1 rounded text-xs font-bold ${angle === a ? 'bg-purple-500/40 text-purple-300' : 'bg-white/10 text-gray-400'}`}>
                {a}°
              </button>
            ))}
          </div>
          ...
          {trigValues[angle] && (
            <motion.div className="bg-yellow-500/10 rounded-xl p-4 border border-yellow-500/20"
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                <div>
                  <p className="text-green-400 text-xs">sin</p>
                  <p className="text-white font-bold">{trigValues[angle].sin}</p>
                </div>
                <div>
                  <p className="text-blue-400 text-xs">cos</p>
                  <p className="text-white font-bold">{trigValues[angle].cos}</p>
                </div>
                <div>
                  <p className="text-orange-400 text-xs">tan</p>
