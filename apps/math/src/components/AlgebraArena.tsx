  ...
  const BalanceScale = ({ eq }: { eq: Equation }) => {
    ...
    return (
      <div className="flex flex-col items-center my-4">
        ...
        <div className="mt-8 text-gray-500 text-xs">⚖️ Both sides must be equal</div>
      </div>
    );
  };
    ...
    <div className="w-full">
      ...
      >
        <div className="text-center mb-2">
          <span className="text-xs bg-purple-500/30 text-purple-300 px-3 py-1 rounded-full">{equation.difficulty}</span>
        </div>
