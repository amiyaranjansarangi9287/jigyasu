      ...
      <div className="max-w-md mx-auto space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button className="text-xs text-gray-500 hover:text-white px-2 py-1 rounded bg-white/5" onClick={puzzleType === 'sudoku' ? checkSudoku : checkKenKen}>Check</button>
            <button className="text-xs text-gray-500 hover:text-white px-2 py-1 rounded bg-white/5" onClick={puzzleType === 'sudoku' ? newSudoku : newKenKen}>New</button>
          </div>
        </div>
