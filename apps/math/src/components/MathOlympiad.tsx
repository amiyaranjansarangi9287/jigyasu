    ...
    <div className="w-full">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <span className="text-xs bg-amber-500/30 text-amber-300 px-2 py-0.5 rounded-full">{problem.category}</span>
          <span className="text-xs text-gray-400">{diffStars}</span>
        </div>
