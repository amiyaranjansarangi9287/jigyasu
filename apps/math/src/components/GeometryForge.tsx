        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          {triples.map(([ta, tb, tc]) => (
            <motion.button key={`${ta}-${tb}`}
              className={`text-xs px-2 py-2 rounded-lg border text-center transition-all ${a === ta && b === tb ? 'bg-purple-500/30 border-purple-400 text-purple-300' : 'bg-white/5 border-white/10 text-gray-400 hover:bg-white/10'}`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-white/5 rounded-2xl p-4 border border-white/10 flex flex-col items-center">
          ...
          <div className="space-y-2 w-full">
            <div className="flex items-center gap-2">
              <label className="text-gray-400 text-xs w-24">{shape === 'circle' ? 'Radius' : shape === 'trapezoid' ? 'Base b' : 'Length'}</label>
            ...
            {shape !== 'circle' && (
              <div className="flex items-center gap-2">
                <label className="text-gray-400 text-xs w-24">{shape === 'rectangle' ? 'Width' : 'Height'}</label>
            ...
            {shape === 'trapezoid' && (
              <div className="flex items-center gap-2">
                <label className="text-gray-400 text-xs w-24">Top a</label>
        ...
        <div className="space-y-3">
          <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl p-5 border border-blue-500/20">
            <p className="text-gray-400 text-xs mb-1">Formula</p>
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-teal-500/10 rounded-2xl p-5 border border-green-500/20">
            <p className="text-gray-400 text-xs mb-1">Perimeter / Circumference</p>
