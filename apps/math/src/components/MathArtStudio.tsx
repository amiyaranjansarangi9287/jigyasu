      ...
      <div className="space-y-4">
        ...
        <div className="bg-yellow-500/10 rounded-2xl p-5 border border-yellow-500/20">
          ...
          <div className="grid grid-cols-2 gap-2 mt-4">
            <div className="bg-white/5 rounded-xl p-3 text-center"><p className="text-gray-500 text-xs">Width</p><p className="text-white font-bold">{rectW.toFixed(0)}</p></div>
            <div className="bg-white/5 rounded-xl p-3 text-center"><p className="text-gray-500 text-xs">Height</p><p className="text-white font-bold">{rectH.toFixed(1)}</p></div>
            <div className="bg-white/5 rounded-xl p-3 text-center col-span-2"><p className="text-gray-500 text-xs">Width ÷ Height</p><p className="text-yellow-400 font-bold text-2xl">{(rectW / rectH).toFixed(3)}</p></div>
          </div>
        </div>
      </div>
    </div>
