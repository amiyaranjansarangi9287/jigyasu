...
export default function Visualizer3D() {
  ...
  const renderBlocks = (count: number, color: string, label: string) => {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        {count > 50 && <span className="text-xs text-gray-500 mt-1">(showing 50 of {count})</span>}
      </div>
    );
  };
  ...
  return (
    <div className="w-full">
      ...
      {/* Visualization Area */}
      <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6 min-h-[250px] flex items-center justify-center perspective-1000">
