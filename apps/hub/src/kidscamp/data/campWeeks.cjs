...
exports.getCampWeeksByAge = exports.getCampWeekById = exports.campWeeks = void 0;
exports.campWeeks = [
    {
        id: 'ocean-explorers',
...
var getCampWeekById = function (id) {
    return exports.campWeeks.find(function (w) { return w.id === id; });
};
exports.getCampWeekById = getCampWeekById;
var getCampWeeksByAge = function (age) {
    return exports.campWeeks.filter(function (w) { return w.ageRange === 'all' || w.ageRange === age; });
};
exports.getCampWeeksByAge = getCampWeeksByAge;
