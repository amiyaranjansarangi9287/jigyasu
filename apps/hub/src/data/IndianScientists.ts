...
export const INDIAN_SCIENTISTS: IndianScientist[] = [
  // Ancient Scientists
  {
    ...
    contribution: 'Discovered that Earth rotates on its axis and orbits the Sun. Described gravity as a natural attraction 1,100 years before Newton.',
    year: 476,
    era: 'ancient',
  ...
  },
  {
    ...
    field: 'Mathematics',
    contribution: 'First to define zero as a number and developed rules for arithmetic with zero. Discovered gravity as an attractive force.',
    year: 598,
    era: 'ancient',
    story: 'Brahmagupta was born in Ujjain, Madhya Pradesh. He was the first mathematician to treat zero as a number, not just a placeholder. His book Brahmasphutasiddhanta introduced the concept of negative numbers and described gravity as an attractive force - centuries before Newton!',
  ...
  // Medieval Scientists
  {
    ...
    year: 1114,
    era: 'medieval',
    story: 'Bhaskara II was born in Bijapur, Karnataka. He was the first mathematician to describe differential calculus - 500 years before Newton and Leibniz! His book Lilavati is famous for its mathematical problems presented through stories.',
  ...
  },
  {
    ...
    year: 1350,
    era: 'medieval',
    story: 'Madhava lived in Kerala and founded the famous Kerala School of Mathematics. He discovered infinite series for π (pi) and sine functions - 200 years before European mathematicians! His work laid the foundation for calculus.',
