  ...
  return (
    <AcademyShell module="economic-indicators">
      <div className="min-h-screen bg-slate-950 p-5 pb-24">
        ...
        <p className="text-slate-500 text-sm font-bold mb-2 uppercase">Policy decisions</p>
        ...
        <div className="mt-4 bg-amber-950/30 border border-amber-900/30 rounded-xl p-3 text-sm text-amber-300">🇮🇳 RBI and Finance Ministry make these trade-offs quarterly.</div>
      </div>
    </AcademyShell>
  );
}