      ...
      <div className="flex-1 flex flex-col p-5 bg-slate-950 pb-24">
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-800 mb-4 overflow-hidden" style={{ height: '160px' }}>
          <div className="w-full h-full flex items-center justify-center gap-8 relative">
            {/* Anode */}
            <div className="text-center"><div className="w-12 h-24 bg-slate-600 rounded-lg mb-1" /><p className="text-red-400 text-sm font-bold">Anode (−)</p><p className="text-slate-500 text-sm">Oxidation</p></div>
            {/* Electron flow */}
            {showElectrons && (
              <div className="absolute top-4 left-1/2 -translate-x-1/2 flex gap-1">
                ...
                <p className="text-yellow-400 text-sm ml-2">e⁻ →</p>
              </div>
            )}
            {/* Wire */}
            <div className="w-20 h-0.5 bg-yellow-600" />
            {/* Cathode */}
            <div className="text-center"><div className="w-12 h-24 bg-amber-700 rounded-lg mb-1" /><p className="text-blue-400 text-sm font-bold">Cathode (+)</p><p className="text-slate-500 text-sm">Reduction</p></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="bg-red-950/30 rounded-xl p-3 border border-red-900/30">
            <p className="text-red-400 text-sm font-bold mb-1">Oxidation</p>
            <p className="text-white text-sm font-mono">{ctx.ox}</p>
            <p className="text-slate-500 text-sm mt-1">Loses electrons</p>
          </div>
          <div className="bg-blue-950/30 rounded-xl p-3 border border-blue-900/30">
            <p className="text-blue-400 text-sm font-bold mb-1">Reduction</p>
            <p className="text-white text-sm font-mono">{ctx.red}</p>
            <p className="text-slate-500 text-sm mt-1">Gains electrons</p>
          </div>
        </div>
