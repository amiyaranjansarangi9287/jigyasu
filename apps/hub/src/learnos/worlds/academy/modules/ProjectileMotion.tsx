      ...
      <div className="flex-1 flex flex-col p-5 bg-slate-950 pb-24">
        ...
        <div className="space-y-3 mb-4">
          <div className="bg-slate-900 rounded-xl p-3 border border-slate-800">
            <div className="flex justify-between text-sm mb-1"><span className="text-slate-400">Launch Angle</span><span className="text-white font-bold">{angle}°</span></div>
          ...
          <div className="bg-slate-900 rounded-xl p-3 border border-slate-800">
            <div className="flex justify-between text-sm mb-1"><span className="text-slate-400">Initial Speed</span><span className="text-white font-bold">{speed} m/s</span></div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="bg-slate-900 rounded-xl p-3 text-center border border-slate-800"><p className="text-cyan-400 text-sm font-bold">Range</p><p className="text-white font-mono font-bold">{range}m</p></div>
          <div className="bg-slate-900 rounded-xl p-3 text-center border border-slate-800"><p className="text-amber-400 text-sm font-bold">Max Height</p><p className="text-white font-mono font-bold">{maxH}m</p></div>
          <div className="bg-slate-900 rounded-xl p-3 text-center border border-slate-800"><p className="text-purple-400 text-sm font-bold">Time</p><p className="text-white font-mono font-bold">{tof}s</p></div>
        </div>

        <button onClick={handleFire} className="w-full py-4 bg-cyan-600 text-white font-bold rounded-2xl min-h-[52px]">🚀 Fire!</button>
        ...
        {fired && angle === 45 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-4 bg-cyan-900/20 border border-cyan-700/30 rounded-2xl p-4 text-center">
            <p className="text-cyan-400 font-bold text-sm">🎯 45° = Maximum Range!</p>
            <p className="text-slate-400 text-sm mt-1">R = u²sin(2θ)/g. Max when sin(2θ) = 1, θ = 45°</p>
          </motion.div>
        )}
      </div>
    </AcademyShell>
