  ...
  return (
    <AcademyShell module="essay-architect">
      <div className="min-h-screen bg-slate-950 p-5 pb-24">
        ...
        <div className="bg-slate-900 rounded-xl p-3 border border-slate-800 mb-4"><div className="flex justify-between text-sm mb-2"><span className="text-slate-400 font-bold">Flow Score</span><span className="text-white font-bold">{score}/100</span></div><div className="h-2 bg-slate-800 rounded-full"><div className="h-full bg-violet-500 rounded-full" style={{ width: `${score}%` }} /></div></div>
        ...
        <button onClick={saveEssay} className="w-full mt-4 py-4 bg-violet-700 text-white rounded-2xl font-bold">Save Structure</button>
      </div>
    </AcademyShell>
  );
}
