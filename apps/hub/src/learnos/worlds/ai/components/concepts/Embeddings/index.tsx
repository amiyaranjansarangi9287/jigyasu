...
export default function Embeddings({ onComplete }: EmbeddingsProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-violet-50 py-6 px-4">
