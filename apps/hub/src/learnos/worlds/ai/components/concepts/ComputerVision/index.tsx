...
export default function ComputerVision({ onComplete }: ComputerVisionProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 via-white to-cyan-50 py-6 px-4">
