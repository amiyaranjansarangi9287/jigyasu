...
export default function GenerativeAI({ onComplete }: Props) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-fuchsia-50 via-white to-purple-50 py-4 sm:py-6 px-4">
