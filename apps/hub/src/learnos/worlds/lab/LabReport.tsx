          ...
          {report && (
            <div className="p-5 space-y-4">
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-slate-800 rounded-2xl p-3 text-center"><div className="text-2xl font-bold text-white">{report.totalExplored}</div><div className="text-sm text-slate-400">of {report.total}</div></div>
                <div className="bg-slate-800 rounded-2xl p-3 text-center"><div className="text-2xl font-bold text-purple-400">{report.crossConcepts}</div><div className="text-sm text-slate-400">connections</div></div>
                <div className="bg-slate-800 rounded-2xl p-3 text-center"><div className="text-2xl font-bold text-amber-400">{report.minutes}</div><div className="text-sm text-slate-400">minutes</div></div>
              </div>
              <div className="bg-slate-800 rounded-2xl p-4">
                <p className="text-slate-400 text-sm font-bold uppercase mb-3">Certifications</p>
