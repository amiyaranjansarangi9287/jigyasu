      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 bg-slate-900/90 flex items-end justify-center">
        <motion.div initial={{ y: 80 }} animate={{ y: 0 }} exit={{ y: 80 }} className="bg-slate-900 rounded-t-3xl w-full max-w-md p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2"><span className="text-2xl">🦚</span><div><p className="text-white font-bold text-sm"><Trans i18nKey="auto.expertmode.expert_mode">Expert Mode</Trans></p><p className="text-slate-400 text-sm"><Trans i18nKey="auto.expertmode.explain_to_lumo">Explain to Lumo</Trans></p></div></div>
