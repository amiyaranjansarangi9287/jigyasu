    ...
    <LabShell module="weather-station" subject="earth-science">
      <div className="flex flex-col h-screen bg-sky-50 overflow-auto pb-24 p-6">
        <div className="bg-white p-6 rounded-3xl shadow-sm mb-6 border border-sky-100">
          <div className="flex items-center gap-4 mb-4"><span className="text-4xl">{t('lab.modules.WeatherStation.spn_', '🌤️')}</span><h2 className="text-xl font-bold">Weather Station</h2></div>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-blue-50 rounded-xl"><p className="text-sm text-blue-400 font-bold uppercase">{t('lab.modules.WeatherStation.txt_Temp', 'Temp')}</p><p className="text-lg font-mono font-bold text-blue-700">{sc.readings.temperature}°C</p></div>
            ...
            <div className="p-3 bg-slate-50 rounded-xl"><p className="text-sm text-slate-400 font-bold uppercase">{t('lab.modules.WeatherStation.txt_Pressure', 'Pressure')}</p><p className="text-lg font-mono font-bold text-slate-700">{sc.readings.pressure}hPa</p></div>
            <div className="p-3 bg-indigo-50 rounded-xl"><p className="text-sm text-indigo-400 font-bold uppercase">{t('lab.modules.WeatherStation.txt_Wind', 'Wind')}</p><p className="text-lg font-mono font-bold text-indigo-700">{sc.readings.windSpeed}km/h</p></div>
          </div>
        </div>
