  ...
  return (
    <DiscoveryShell module="speed-distance-time">
      <div className="flex-1 flex flex-col p-6 bg-slate-900">
        <div className="bg-slate-800 p-4 rounded-2xl border border-slate-700 mb-6 flex justify-between items-center"><h2 className="text-white font-bold">Speed Monitor</h2><div className="bg-indigo-600 px-3 py-1 rounded-full text-white font-mono font-bold">{speed} km/h</div></div>
