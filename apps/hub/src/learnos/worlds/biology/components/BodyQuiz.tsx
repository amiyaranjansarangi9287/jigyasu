...
const allQuestions: Question[] = [
  // Easy
  { id: 1, question: 'What is the largest organ in the human body?', options: ['Heart', 'Liver', 'Skin', 'Brain'], correct: 2, system: 'Integumentary', emoji: '🧴', explanation: 'The skin is the largest organ, weighing about 3.6 kg and covering about 2 square metres!', difficulty: 'easy' },
  ...
  { id: 24, question: 'How much blood does the body contain?', options: ['2-3 litres', '4-5 litres', '7-8 litres', '10-12 litres'], correct: 1, system: 'Circulatory', emoji: '🩸', explanation: 'Adults have about 4.7-5.5 litres of blood circulating at all times.', difficulty: 'hard' },
