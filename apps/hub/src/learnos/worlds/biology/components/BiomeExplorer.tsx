...
const biomes: Biome[] = [
  {
    ...
    temperature: '25-30°C', precipitation: '200-450 cm/year',
    location: 'Western Ghats, Northeast India, Amazon Basin, Congo',
    ...
    flora: [{ name: 'Teak', emoji: '🌳' }, { name: 'Orchids', emoji: '🌸' }, { name: 'Bamboo', emoji: '🌿' }, { name: 'Lianas', emoji: '🌱' }],
    fauna: [{ name: 'Tiger', emoji: '🐅' }, { name: 'Great Hornbill', emoji: '🦜' }, { name: 'Tree Frog', emoji: '🐸' }, { name: 'Monkey', emoji: '🐒' }],
  ...
  },
  {
    ...
    location: 'Thar Desert, Sahara, Gobi, Arabian',
    ...
    flora: [{ name: 'Khejri', emoji: '🌵' }, { name: 'Date Palm', emoji: '🌴' }, { name: 'Acacia', emoji: '🌿' }, { name: 'Aloe', emoji: '🪴' }],
    fauna: [{ name: 'Camel', emoji: '🐪' }, { name: 'Indian Cobra', emoji: '🐍' }, { name: 'Scorpion', emoji: '🦂' }, { name: 'Desert Fox', emoji: '🦊' }],
  ...
  },
  {
    ...
    funFacts: ['Ground is permanently frozen (permafrost)', 'Trees cannot grow here', 'Arctic terns migrate 70,000 km/year'],
  },
  {
    ...
    location: 'Lakshadweep, Andaman Islands, Great Barrier Reef, Red Sea',
    ...
    flora: [{ name: 'Seagrass', emoji: '🌿' }, { name: 'Kelp', emoji: '🌊' }, { name: 'Algae', emoji: '🟢' }, { name: 'Coral', emoji: '🪸' }],
  ...
  },
  {
    ...
    location: 'Himalayan foothills, Nilgiris, Northeast India',
    ...
    flora: [{ name: 'Oak', emoji: '🌳' }, { name: 'Rhododendron', emoji: '🍁' }, { name: 'Ferns', emoji: '🌿' }, { name: 'Wildflowers', emoji: '🌼' }],
    fauna: [{ name: 'Deer', emoji: '🦌' }, { name: 'Himalayan Black Bear', emoji: '🐻' }, { name: 'Squirrel', emoji: '🐿️' }, { name: 'Owl', emoji: '🦉' }],
    funFacts: ['Fall colors = chlorophyll breaking down', 'Up to 6 forest layers exist', 'These forests cover much of the Himalayan foothills'],
  },
  {
  ...
  },
  {
    ...
    funFacts: ['Most converted biome for agriculture', 'Roots can extend ~1.8 metres deep', 'Prairies once had 60 million bison'],
  },
];
