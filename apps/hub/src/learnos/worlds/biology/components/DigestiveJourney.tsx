...
const organs: DigestiveOrgan[] = [
  { id: 'mouth', name: 'Mouth', emoji: '👄', color: '#ef4444', time: '30 sec - 2 min', pH: '6.5–7.5 (neutral)',
    ...
    funFact: 'You produce about 1-1.5 litres of saliva every day — over a lifetime, that adds up to thousands of litres! Saliva contains opiorphin, a natural pain-killing chemical that helps protect sensitive mouth tissue.' },
  ...
  { id: 'stomach', name: 'Stomach', emoji: '🫃', color: '#eab308', time: '2-6 hours', pH: '1.5–3.5 (very acidic!)',
    ...
    funFact: 'Your stomach acid (HCl) is strong enough to corrode some metals! The stomach replaces its entire lining every 3-4 days to avoid digesting itself.' },
  { id: 'liver', name: 'Liver & Gallbladder', emoji: '🟤', color: '#92400e', time: 'Continuous', pH: 'Bile pH: 7-8 (alkaline)',
    ...
    funFact: 'The liver performs over 500 functions! It is one of the few internal organs that can fully regenerate — you can donate up to 75% and it grows back over time.' },
  ...
  { id: 'small', name: 'Small Intestine', emoji: '🌀', color: '#10b981', time: '3-5 hours', pH: '6-7.5',
    ...
    funFact: 'The small intestine is ~6 metres long! Its inner surface area (due to villi) is about the size of a tennis court — ~250 sq m!' },
  { id: 'large', name: 'Large Intestine (Colon)', emoji: '🔄', color: '#3b82f6', time: '12-36 hours', pH: '5.5-7 (slightly acidic)',
    ...
    funFact: 'Your gut contains trillions of bacteria — roughly similar in number to your own body cells! This "microbiome" weighs about 2 kg and is unique like a fingerprint.' },
        ...
        <div className="flex items-center justify-center gap-1 mb-6 overflow-x-auto pb-2 px-4">
          {organs.map((o, i) => (
            <div key={o.id} className="flex items-center">
              ...
              {i < organs.length - 1 && (
                <motion.span
                  className={`mx-0.5 text-sm ${i < currentOrgan ? 'text-emerald-500' : 'text-gray-700'}`}
