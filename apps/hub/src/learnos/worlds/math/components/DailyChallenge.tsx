    ...
    <div className="max-w-lg mx-auto">
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm bg-purple-500/30 text-purple-300 px-2 py-1 rounded-full">{challenge.category}</span>
          <span className={`text-sm font-bold ${difficultyColor[challenge.difficulty]}`}>{challenge.difficulty}</span>
        </div>
