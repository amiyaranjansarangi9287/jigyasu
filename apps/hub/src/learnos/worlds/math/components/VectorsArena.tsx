          ...
          <motion.div key="ex" className="grid grid-cols-1 lg:grid-cols-2 gap-6" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
            <div className="space-y-4">
              <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div><label className="text-gray-400 text-sm">x</label><input type="range" min="-5" max="5" value={ax} onChange={e => setAx(Number(e.target.value))} className="w-full accent-blue-500" /><p className="text-white font-bold text-center">{ax}</p></div>
                  <div><label className="text-gray-400 text-sm">y</label><input type="range" min="-5" max="5" value={ay} onChange={e => setAy(Number(e.target.value))} className="w-full accent-blue-500" /><p className="text-white font-bold text-center">{ay}</p></div>
                </div>
              </div>
              <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
                <h4 className="text-orange-400 font-bold mb-2">Vector B</h4>
                <div className="grid grid-cols-2 gap-3">
                  <div><label className="text-gray-400 text-sm">x</label><input type="range" min="-5" max="5" value={bx} onChange={e => setBx(Number(e.target.value))} className="w-full accent-orange-500" /><p className="text-white font-bold text-center">{bx}</p></div>
                  <div><label className="text-gray-400 text-sm">y</label><input type="range" min="-5" max="5" value={by} onChange={e => setBy(Number(e.target.value))} className="w-full accent-orange-500" /><p className="text-white font-bold text-center">{by}</p></div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-green-500/10 rounded-xl p-3 border border-green-500/20 text-center"><p className="text-gray-400 text-sm">A + B</p><p className="text-green-400 font-bold">({sum.x}, {sum.y})</p></div>
                <div className="bg-purple-500/10 rounded-xl p-3 border border-purple-500/20 text-center"><p className="text-gray-400 text-sm">A · B</p><p className="text-purple-400 font-bold">{dot}</p></div>
                <div className="bg-blue-500/10 rounded-xl p-3 border border-blue-500/20 text-center"><p className="text-gray-400 text-sm">|A|</p><p className="text-blue-400 font-bold">{magA.toFixed(2)}</p></div>
                <div className="bg-orange-500/10 rounded-xl p-3 border border-orange-500/20 text-center"><p className="text-gray-400 text-sm">|B|</p><p className="text-orange-400 font-bold">{magB.toFixed(2)}</p></div>
              </div>
              <div className="bg-yellow-500/10 rounded-xl p-3 border border-yellow-500/20 text-center"><p className="text-gray-400 text-sm">Angle between</p><p className="text-yellow-400 font-bold">{angle.toFixed(1)}°</p></div>
            </div>
