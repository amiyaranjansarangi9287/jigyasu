...
export const MISTAKE_EXHIBITS: MistakeExhibit[] = [
  {
    ...
    indianConnection: 'Aryabhata (499 CE) proposed Earth rotates on its axis — an early insight into planetary motion that emerged independently in India.',
    emoji: '🌍',
  ...
  },
  {
    ...
    overturned: 'Pythagoras (traditionally dated around 500 BCE) reasoned Earth must be spherical. Ships disappear hull-first over horizon.',
  ...
  },
  {
    ...
    indianConnection: 'Sushruta (traditionally dated around 600 BCE) emphasized cleanliness and boiling water — practical hygiene that anticipated modern concepts.',
    emoji: '💨',
  ...
  },
  {
    ...
    indianConnection: 'Indian philosophers (Nyaya school) explored the nature of light and vision, developing early theories about how light enables sight — showing sophisticated inquiry into optical phenomena.',
    emoji: '💡',
