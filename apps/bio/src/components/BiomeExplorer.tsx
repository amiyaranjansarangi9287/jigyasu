              ...
              <div className="absolute inset-0 opacity-10">
                {Array.from({ length: 20 }).map((_, i) => (
                  <div key={i} className="absolute text-4xl opacity-20"
                    style={{ left: `${Math.random() * 90}%`, top: `${Math.random() * 80}%` }}>
                    {selectedBiome.emoji}
                  </div>
                ))}
              </div>
              ...
              <div className="relative p-6 md:p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    {/* Location */}
                    <div className="inline-block bg-black/30 backdrop-blur rounded-lg px-3 py-1.5 text-xs text-gray-300">
                  ...
                  <div className="flex-shrink-0 w-full md:w-64 space-y-3">
                    ...
                    <div className="bg-black/30 backdrop-blur rounded-xl p-4">
                      <div className="text-xs text-gray-400 mb-1">🌤️ Climate</div>
