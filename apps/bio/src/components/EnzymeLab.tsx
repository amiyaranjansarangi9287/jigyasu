        ...
        <div className="grid lg:grid-cols-3 gap-5">
          ...
          <div className="space-y-4">
            <div className="bg-gray-900 rounded-2xl border border-gray-800 p-5">
              ...
              <div className="mb-5">
                <div className="flex justify-between mb-1">
                  <span className="text-xs text-gray-400 flex items-center gap-1"><Thermometer className="w-3 h-3" /> Temperature</span>
                  <span className={`text-xs font-mono font-bold ${temperature > 60 ? 'text-red-400' : temperature < 10 ? 'text-blue-400' : 'text-white'}`}>{temperature}°C</span>
                </div>
              ...
              <div className="mb-5">
                <div className="flex justify-between mb-1">
                  <span className="text-xs text-gray-400">⚗️ pH Level</span>
                  <span className={`text-xs font-mono font-bold ${Math.abs(pH - enzyme.optPH) < 1 ? 'text-emerald-400' : 'text-yellow-400'}`}>{pH.toFixed(1)}</span>
                </div>
              ...
              <div className="mb-4">
                <div className="flex justify-between mb-1">
                  <span className="text-xs text-gray-400">📦 Substrate Concentration</span>
                  <span className="text-xs font-mono text-white">{substrate.toFixed(0)}%</span>
                </div>
            ...
            <div className="bg-gray-900 rounded-2xl border border-gray-800 p-5">
              ...
              <div className="text-xs text-gray-500 mb-2">📍 {enzyme.location}</div>
              <div className="text-xs text-gray-400 mb-3">Reaction: <span className="text-white font-mono">{enzyme.substrate}</span></div>
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div className="bg-gray-800/50 rounded-lg p-2 text-center">
                  <div className="text-[10px] text-gray-500">Optimal Temp</div>
                  <div className="text-sm font-bold text-emerald-400">{enzyme.optTemp}°C</div>
                </div>
                <div className="bg-gray-800/50 rounded-lg p-2 text-center">
                  <div className="text-[10px] text-gray-500">Optimal pH</div>
                  <div className="text-sm font-bold text-emerald-400">{enzyme.optPH}</div>
                </div>
              </div>
              <div className="bg-blue-500/10 rounded-lg p-2 border border-blue-500/20">
                <div className="text-[10px] text-blue-400 font-bold">💡 Fun Fact</div>
                <div className="text-xs text-gray-300">{enzyme.fact}</div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-900 rounded-2xl border border-gray-800 p-5">
              ...
              <div className="grid grid-cols-3 gap-4 mb-5">
                <div className="text-center">
                  <div className="text-xs text-gray-500 mb-1">Activity Rate</div>
                  ...
                  {isDenatured && <div className="text-xs text-red-400 font-bold">DENATURED!</div>}
                </div>
                <div className="text-center">
                  <div className="text-xs text-gray-500 mb-1">Product Made</div>
                ...
                <div className="text-center">
                  <div className="text-xs text-gray-500 mb-1">Substrate Left</div>
              ...
              <div className="mt-4 space-y-1.5">
                ...
                {substrate <= 0 && (
                  <div className="text-xs text-orange-400 bg-orange-500/10 rounded-lg px-3 py-2 border border-orange-500/20">
