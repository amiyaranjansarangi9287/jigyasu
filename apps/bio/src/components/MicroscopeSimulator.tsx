        ...
        <div className="grid lg:grid-cols-3 gap-5">
          ...
          <div className="lg:col-span-2">
            <div className="relative">
              ...
              >
                ...
                {/* Zoom indicator */}
                <div className="absolute top-3 left-3 bg-black/70 backdrop-blur px-2.5 py-1 rounded-full text-xs text-emerald-400 font-mono">
          ...
          <div className="space-y-4">
              ...
              <motion.div key={specimen.id}
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-emerald-400 font-medium">{specimen.category} • {specimen.magnification}</div>
                  </div>
                </div>
                <p className="text-gray-300 text-xs leading-relaxed mb-3">{specimen.description}</p>

                <div className="bg-gray-800/50 rounded-lg p-2.5 mb-3">
                  <div className="text-[10px] text-gray-500 uppercase font-bold">Stain Used</div>
                  <div className="text-xs text-white">{specimen.stain}</div>
                </div>

                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 mb-3">
                  <div className="text-[10px] text-blue-400 font-bold mb-1">💡 Fun Fact</div>
                  <div className="text-xs text-gray-300">{specimen.funFact}</div>
                </div>

                <h4 className="text-xs font-bold text-white mb-2 uppercase tracking-wider">Visible Structures</h4>
            ...
            <div className="bg-gray-900 rounded-2xl border border-gray-800 p-4">
              <h4 className="text-xs font-bold text-white mb-2">🔬 Microscope Tips</h4>
