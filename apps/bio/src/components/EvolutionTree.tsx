    ...
    <div className="relative">
      ...
      >
        ...
        <div className="min-w-0">
          ...
          <div className="text-[10px] text-gray-500">{node.years}</div>
        </div>
      </motion.button>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selected.children.map(c => (
                          <span key={c.id} className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-gray-800 text-gray-300">
                            {c.emoji} {c.name}
                          </span>
                        ))}
                      </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={t.era} className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-300 font-medium w-20">{t.era}</span>
