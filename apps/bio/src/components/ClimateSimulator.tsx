    ...
    <div className="min-h-screen bg-gray-950 pt-20 pb-10 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-6">
          ...
          <div className={`bg-gray-900 rounded-xl border border-gray-800 px-6 py-3 text-center`}>
            <div className="text-xs text-gray-500 uppercase font-bold">Scenario</div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-900 rounded-2xl border border-gray-800 p-5">
              ...
              <div className="mb-4">
                <div className="flex justify-between mb-1">
                  <span className="text-xs text-gray-400">Fossil Fuel Emissions</span>
                  <span className="text-xs font-mono text-gray-300">{emissions < 30 ? 'Net Zero Path' : emissions < 70 ? 'Moderate' : 'High'}</span>
                </div>
              ...
              <div className="mb-4">
                <div className="flex justify-between mb-1">
                  <span className="text-xs text-gray-400">Deforestation Rate</span>
                  <span className="text-xs font-mono text-gray-300">{deforestation < 30 ? 'Reforestation' : deforestation < 70 ? 'Current' : 'Accelerated'}</span>
                </div>
              ...
              <div className="mb-4">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-xs font-mono text-emerald-400">{renewables}%</span>
                </div>
              ...
              <div className="flex items-center gap-2">
                ...
                {[1, 2, 5, 10].map(s => (
                  <button key={s} onClick={() => setSpeed(s)}
                    className={`px-2 py-0.5 rounded text-xs font-bold ${speed === s ? 'bg-emerald-500 text-white' : 'bg-gray-800 text-gray-400'}`}>
                    {s}x
                  </button>
                ))}
              </div>
            ...
            <div className="bg-blue-500/10 rounded-xl border border-blue-500/20 p-4">
              <div className="text-xs text-blue-400 font-bold mb-2">🌍 Paris Agreement Targets</div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
                ...
                <div className="text-[10px] text-gray-600">vs pre-industrial</div>
              </div>
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
                ...
                <div className="text-[10px] text-gray-600">Pre-industrial: 280 ppm</div>
              </div>
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
                ...
                <div className="text-[10px] text-gray-600">vs 1900 baseline</div>
              </div>
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
                ...
                <div className="text-[10px] text-gray-600">of land surface</div>
              </div>

              <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
                <div className="text-xs text-gray-500 mb-1">🧊 Ice Sheets</div>
              ...
              <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
                <div className="text-xs text-gray-500 mb-1">⛈️ Extreme Events</div>
                ...
                <div className="text-[10px] text-gray-600">floods, fires, storms</div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-b from-sky-950 via-blue-950 to-green-950 rounded-2xl border border-gray-700 p-6 relative overflow-hidden min-h-[200px]">
              ...
              {/* CO2 molecules */}
              {Array.from({ length: Math.min(20, Math.floor((state.co2 - 280) / 10)) }).map((_, i) => (
                <motion.div key={i}
                  className="absolute text-xs opacity-30"
                  initial={{ x: Math.random() * 100 + '%', y: Math.random() * 60 + '%' }}
                  animate={{ y: [0, -10, 0] }}
