...
export default function ActivityMode({
  ...
  useEffect(() => {
    startActivity();
    // Auto-start timer if resuming building phase
    if (phase === 'building' && !progress.completedAt) {
          ...
          {Array.from({ length: 50 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                backgroundColor: ['#FF6B35', '#4ECDC4', '#FFD93D', '#FF6B9D', '#6BCB77'][Math.floor(Math.random() * 5)],
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="hidden sm:inline" aria-hidden="true">Back</span>
            </button>
          ...
          <div className="max-w-2xl mx-auto px-4 py-8 sm:py-12 text-center">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-8">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm">
                ...
                <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Total Time</div>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm">
                ...
                <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Steps Done</div>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm">
                ...
                <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Pillar</div>
              </div>
            </div>
