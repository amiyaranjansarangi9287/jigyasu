...
export default function ToddlerZone({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-100 via-purple-50 to-blue-100 dark:from-pink-900/30 dark:via-purple-900/20 dark:to-blue-900/30 toddler-zone">
      {/* Header */}
      <header className="sticky top-0 z-40 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-lg">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {filteredActivities.length === 0 && (
            <div className="text-center py-16">
              ...
              <button
                onClick={() => setSelectedPillar(null)}
                className="mt-4 btn btn-primary text-lg"
              >
                Show All Activities
              </button>
            </div>
