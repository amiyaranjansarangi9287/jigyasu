...
import { ButWhy } from '@jigyasu/ui'
const StatesOfMatterCanvas = lazy(() => import('../../components/canvases/StatesOfMatterCanvas'));
...
export default function StatesOfMatter() {
  ...
  return (
    <div className="max-w-5xl mx-auto animate-fade-in">
      ...
      <ButWhy title="But WHY does heat change matter?">
        <p className="mb-4">
          Imagine you and your friends are holding hands and standing very still (like a <b>Solid</b>). 
        </p>
        <p className="mb-4">
          When we add heat, it's like turning on energetic dance music! You all start wiggling and moving around. 
          Eventually, you let go of hands and start dancing around the room (like a <b>Liquid</b>).
        </p>
        <p>
          If the music gets super crazy (more heat!), you all start running around so fast you bounce off the walls! 
          That's exactly what atoms do when they become a <b>Gas</b>. Heat is just energy that makes atoms dance!
        </p>
      </ButWhy>
    </div>
  )
